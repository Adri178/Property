...
<body>
    ...
    <body>
        ...
        <script>
            ...
            const createOverlayCta = (overlayCard, ctaEl, level) => {
                const overlayCta = document.createElement("div");
                overlayCta.classList.add("cta");
                overlayCta.textContent = ctaEl.textContent;
                overlayCta.setAttribute("aria-hidden", true);
                overlayCta.addEventListener("click", () => redirectToRegister(level));
            ...
            const initOverlayCard = (cardEl, level) => {
                const overlayCard = document.createElement("div");
                overlayCard.classList.add("card");
                createOverlayCta(overlayCard, cardEl.lastElementChild, level);
            ...
            cards.forEach((card, index) => {
                const level = index + 1;
                initOverlayCard(card, level);
            });

            document.body.addEventListener("pointermove", applyOverlayMask);

            function redirectToRegister(level) {
